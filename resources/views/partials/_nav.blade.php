            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/training-templates/index">
                            Training templates
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/nutrition-templates/create">
                            Nutrition templates
                        </a>
                    </li>
                </ul>
                @if (Auth::check())
                    ...
                    <a class="navbar-btn btn btn-sm btn-primary ms-2" href="/logout">
