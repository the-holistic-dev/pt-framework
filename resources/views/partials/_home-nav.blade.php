    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a class="navbar-brand" href="/">
                <svg width="200" height="75" viewBox="0 0 350 217.90153563071053">
                    <defs id="SvgjsDefs4269"></defs>
                    <g id="SvgjsG4270" featurekey="rDwwlG-0"
                        transform="matrix(1.74999783039362,0,0,1.74999783039362,87.49966621440308,-17.49775028507674)"
                        fill="#4ecca3">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="dropdown-img-start">
                                        <div class="position-absolute top-0 bottom-0 start-0 end-0">
                                            <img src="{{ asset('images/patterns/pattern-1.svg') }}" alt="pattern"
                                                class="object-fit-cover img-fluid w-100 h-100">
                                        </div>
                                        <!-- Heading -->
                ...
                @if (Auth::check())
                    ...
                    @else
                        ...
                        @endphp
                    @endif
                    <a class="navbar-btn btn btn-sm btn-primary ms-auto" href="{{ $url }}">
                        <i class="fe fe-user"></i>
                    </a>
                @else
                    <a class="navbar-btn btn btn-sm btn-primary ms-auto" href="/login">
                        Sign in
                    </a>
                @endif
            </div>
