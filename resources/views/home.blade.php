<x-layout>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6 order-md-2">
                    ...
                    <div class="img-skewed img-skewed-start mb-8 mb-md-0">
                        <img src="assets/img/screenshots/desktop/dashkit.jpg" alt="..."
                            class="screenshot img-fluid mw-md-130" data-aos="img-skewed-item-start"
                            data-aos-delay="100" />
                    </div>
                </div>
                <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
                    ...
                    <h1 class="display-3">
                        ...
                        <span class="text-primary">built with Dashkit</span>.
                    </h1>

                    <!-- Text -->
                    <p class="lead text-body-secondary mb-6 mb-md-8">
                        Intelligent developers use our Dashkit theme to build their
                        internal tools and client admin applications. Save yourself time
                        and money.
                    </p>
                    ...
                    <a href="#!" class="btn btn-primary-subtle lift"> Learn more </a>
                </div>
            </div>
            <!-- / .row -->
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md">
                    ...
                    <blockquote class="blockquote mb-8 mb-md-0">
                        <!-- Logo -->
                        <div class="img-fluid mb-5 mb-md-6" style="max-width: 120px; color: #ff5a5f">
                        ...
                        <p class="lead text-gray-700 mb-5 mb-md-7">
                            ...
                            scheme. Also the additional plugins like the statistics are
                            great and fit perfectly into the overall picture."
                        </p>

                        <!-- Footer -->
                        <p class="fs-sm fw-bold mb-0">Bernhard</p>
                        <p class="fs-sm text-body-secondary mb-0">Dashkit customer</p>
                    </blockquote>
                </div>
                <div class="col-1"></div>
                ...
                <div class="col-12 col-md">
                    ...
                    <blockquote class="blockquote mb-0">
                        <!-- Logo -->
                        <div class="img-fluid mb-5 mb-md-6" style="max-width: 120px; color: #0081c9"></div>

                        <!-- Text -->
                        <p class="lead text-gray-700 mb-5 mb-md-7">
                            “This has been my best theme purchase so far. Simple, beautiful,
                            and I haven't had to make any major changes. It plays well with
                            my changes as well, which is really nice!”
                        </p>

                        <!-- Footer -->
                        <p class="fs-sm fw-bold mb-0">Francisco</p>
                        <p class="fs-sm text-body-secondary mb-0">Dashkit customer</p>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-6">
                    ...
                    <div class="img-skewed img-skewed-end mb-10 mb-md-0">
                        <img src="assets/img/screenshots/ui/dashkit-layered.png" alt="..." class="img-fluid"
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="px-5">
                            <h3 class="mb-0">
                                <span data-countup='{"startVal": 0, "decimalPlaces": 2}' data-to="99.99" data-aos
                                    data-aos-id="countup:in">0.00</span>%
                            </h3>
                        ...
                        <div class="ps-5">
                            <h3 class="mb-0">
                                <span data-countup='{"startVal": 0, "decimalPlaces": 1}' data-to="5.0" data-aos
                                    data-aos-id="countup:in">0.0</span>/5.0
                            </h3>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <p class="fs-lg text-gray-700 mb-6">
                        ...
                        bug, or just need a clarifiction about our documentation? We'll be
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="d-flex">
                                ...
                                <p class="text-success mb-lg-0">Global team</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <!-- Item -->
                            <div class="d-flex">
                                ...
                                <!-- Text -->
                                <p class="text-success">5-star reviews</p>
                            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <!-- Text -->
                                <p class="text-success mb-0">Good looking</p>
                            </div>
                        </div>
                    </div>
                    <!-- / .row -->
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-6 mt-8 me-n5" data-aos="fade-up">
                            <img src="assets/img/photos/photo-10.jpg" alt="..."
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-md-6 col-lg-5 order-md-2">
                    ...
                    <!-- Text -->
                    <p class="fs-lg text-gray-700 mb-8 mb-md-0">
                ...
                <div class="col-12 col-md-6 order-md-1" data-aos="fade-up">
                    <!-- Macbook -->
                    <div class="w-100 w-md-130 float-end mb-6 mb-md-0">
                        <!-- Shape -->
                        <div class="shape shape-blur-4 text-gray-200">
                            <!--blur-4-->
                        </div>

                        <!-- Device -->
                        <div class="device device-macbook">
                            <img src="assets/img/screenshots/desktop/dashkit-alt-dark.jpg" class="device-screen"
                                alt="..." />
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    ...
                    <h2>
                        ...
                        <span class="text-success">simple and flexible.</span>
                    </h2>

                    <!-- Text -->
                    <p class="lead text-gray-700">
                        Companies of all sizes need access to Dashkit, so we have a
                        flexible pricing system for any size of project or company.
                    </p>

                    <!-- Form -->
                    <form class="d-flex align-items-center justify-content-center mb-7 mb-md-9">
                        <!-- Label -->
                        <span class="text-body-secondary"> Annual </span>
                        ...
                        <!-- Label -->
                        <span class="text-body-secondary"> Monthly </span>
                    </form>
                </div>
            </div>
            <!-- / .row -->
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-5">
                    <!-- Card -->
                    <div
                        class="card card-border card-border-xl border-success shadow-light-lg mb-6 mb-md-0 lift lift-lg">
                        <div class="card-body">
                            <!-- Badge -->
                            <h6 class="fw-bold text-uppercase text-center text-success mb-5">
                                Standard
                            </h6>
                            ...
                            <div class="d-flex">
                                ...
                                <!-- Text -->
                                <p class="mb-0">6 months of support</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <div class="card card-border card-border-xl border-dark shadow-light-lg lift lift-lg">
                        <div class="card-body">
                            <!-- Badge -->
                            <h6 class="fw-bold text-uppercase text-center mb-5">
                                Extended
                            </h6>
    ...
    <!-- CTA -->
    <section class="py-10 py-md-14 bg-dark position-relative">
        <div class="position-absolute top-0 bottom-0 start-0 end-0">
            <img src="{{ asset('images/patterns/pattern-1.svg') }}" alt=""
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    <!-- Badge -->
                    <span class="badge rounded-pill text-bg-gray-700-subtle mb-3">
                    ...
                    <p class="fs-lg text-body-secondary mb-6 mb-md-8">
                        Stop wasting time trying to do it the "right way" and build your
                        app from scratch. Dashkit is faster, easier, and you still have
                        complete control.
                    </p>

                    <!-- Button -->
                    <a href="#!" class="btn btn-primary-desat lift">
                        Check it out <i class="fe fe-arrow-right ms-2"></i>
                    </a>
                </div>
            </div>
            <!-- / .row -->
